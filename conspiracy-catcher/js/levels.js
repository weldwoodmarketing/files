...
const LEVELS = [
  ...
  { name: 'Kraken',           creature: 'kraken',     env: 'harbor',  tool: 'forcefield', cSpeed: 88, quest: null,      obstacle: 'crate',    width: 2600, fast: true, blurb: 'Tentacles on the docks! It surges back to the ocean.' },
